...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_XTL_CONTROL] = LAYOUT_65_ansi_blocker(
        ...
        _______, DF_MCOS, DF_WIND, _______, _______, _______, _______, _______, _______, _______, _______, KC_WAKE, KC_SLEP, _______, KC_MUTE,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, BK_LITE,          _L_E_D_, KC_VOLU,
