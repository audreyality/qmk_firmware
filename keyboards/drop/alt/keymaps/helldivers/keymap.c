...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DFL_MACOS] = LAYOUT_65_ansi_blocker(
        ...
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  RM_VALU,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          KC_UP,   RM_VALD,
    ...
    [_XTL_MASK] = LAYOUT_65_ansi_blocker(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL,
    ...
    [_XTL_CONTROL] = LAYOUT_65_ansi_blocker(
        QK_BOOT, TG_NUMP, TG_PROG, _______, _______, _______, _______, _______, _______, _______, _______, EE_CLR,  S_A_V_E, _______, SWAP_OS,
        D_F_L_T, DF_MCOS, DF_WIND, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, BK_LITE, KC_MUTE,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _L_E_D_, KC_VOLU,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, C_O_D_E,          _______, KC_VOLD,
        STH_OFF, STH_DEF, STH_ON ,                            XTLRSVP,                            CTLRSVP, D_F_L_T, KC_MPRV, KC_MPLY, KC_MNXT
    )
    /////////////////////////////////////////////////////////////////////// END //////////////////////////////////////////////////////////////////////////////////////
};
