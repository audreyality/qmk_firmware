...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_XTL_LED_MATRIX] = LAYOUT_65_ansi_blocker(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RM_SPDD,          RM_VALU, RM_NEXT,
        STL_OFF, STLNONE, STLPRTY,                            XTLRSVP,                            CTLRSVP, FNLRSVP, RM_HUED, RM_VALD, RM_HUEU
    ),
    ...
    [_XTL_CONTROL] = LAYOUT_65_ansi_blocker(
        ...
        D_F_L_T, DF_MCOS, DF_WIND, _______, _______, _______, _______, _______, _______, _______, _______, KC_WAKE, KC_SLEP, _L_E_D_, KC_MUTE,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, BK_LITE,          D_F_L_T, KC_VOLU,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, PRTYSRC, C_O_D_E,          _______, KC_VOLD,
        STH_OFF, STH_DEF, STH_ON ,                            XTLRSVP,                            CTLRSVP, H_O_M_E, KC_MPRV, KC_MPLY, KC_MNXT
    )
    /////////////////////////////////////////////////////////////////////// END //////////////////////////////////////////////////////////////////////////////////////
};
